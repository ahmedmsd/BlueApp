...
extension CityQueryFilter on QueryBuilder<City, City, QFilterCondition> {
  ...
  QueryBuilder<City, City, QAfterFilterCondition> regionIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'regionId',
      ));
  ...
  QueryBuilder<City, City, QAfterFilterCondition> regionIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'regionId',
      ));
  ...
  QueryBuilder<City, City, QAfterFilterCondition> regionIdEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'regionId',
        value: value,
  ...
  QueryBuilder<City, City, QAfterFilterCondition> regionIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<City, City, QAfterFilterCondition> regionIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<City, City, QAfterFilterCondition> regionIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CityQuerySortBy on QueryBuilder<City, City, QSortBy> {
  ...
  QueryBuilder<City, City, QAfterSortBy> sortByRegionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'regionId', Sort.asc);
    });
  }

  QueryBuilder<City, City, QAfterSortBy> sortByRegionIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CityQuerySortThenBy on QueryBuilder<City, City, QSortThenBy> {
  ...
  QueryBuilder<City, City, QAfterSortBy> thenByRegionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'regionId', Sort.asc);
    });
  }

  QueryBuilder<City, City, QAfterSortBy> thenByRegionIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'regionId', Sort.desc);
    });
  }
...
extension CityQueryWhereDistinct on QueryBuilder<City, City, QDistinct> {
  ...
  QueryBuilder<City, City, QDistinct> distinctByRegionId() {
    return QueryBuilder.apply(this, (query) {
...
extension CityQueryProperty on QueryBuilder<City, City, QQueryProperty> {
  ...
  QueryBuilder<City, int?, QQueryOperations> regionIdProperty() {
    return QueryBuilder.apply(this, (query) {
