...
class TopHorizontalScrollWidget extends StatelessWidget {
  const TopHorizontalScrollWidget({
    Key? key,
            ...
            return snapshot.data!.isEmpty
                ...
                : BlocBuilder<CertificationCubit, CertificationState>(
                    buildWhen: (previous, current) {
                      return current is ChangeCheckListCategoryState;
                    },
                    builder: (context, state) {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              cubit.changeCheckListCategoryIndex(index);
                              cubit.changeCheckListItemId(
                            ...
                            child: Center(
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: cubit.checkListCategoryIndex == index
