...
import 'package:test_workapp/features/certification/presentation/widgets/check_list_widgets/check_list_comment_widget.dart';
...
class _CheckListCardWidgetState extends State<CheckListCardWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    var index = cubit.tempChecklistItems.indexWhere(
        (element) => element.checklistItemId == widget.checklistDetails.itemId);
    if (index != -1) {
      groupvalue = cubit.tempChecklistItems.elementAt(index).passFail ?? '0';
    } else {
      cubit.tempChecklistItems.add(CheckListItem(
            ...
            children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: AppSvgIcon(
                              ...
                              iconColor: cubit.tempChecklistItems
                                          .elementAt(index)
                                          .comment ==
                                      null
                                  ? null
              ...
              CustomRadioMenuButton(
                ...
                onChange: (val) async {
                  ...
                  cubit.tempChecklistItems.elementAt(index).passFail = val;
