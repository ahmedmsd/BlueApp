...
class LoadTestCheckListCommentWidget extends StatefulWidget {
  const LoadTestCheckListCommentWidget({
    super.key,
  ...
  @override
  State<LoadTestCheckListCommentWidget> createState() =>
      _LoadTestCheckListCommentWidgetState();
}

class _LoadTestCheckListCommentWidgetState
    extends State<LoadTestCheckListCommentWidget> {
  final TextEditingController commentController = TextEditingController();

  @override
  void initState() {
    var index = widget.certificationCubit.tempLoadTestChecklistItems.indexWhere(
        (element) => element.checklistItemId == widget.checklistDetails.itemId);
    commentController.text =
        widget.certificationCubit.tempLoadTestChecklistItems[index].comment ??
            '';
    super.initState();
  }
        ...
        children: [
          ...
          Align(
            ...
            child: CustomButton(
              title: 'Save',
              onPressed: () {
                var index = widget.certificationCubit.tempLoadTestChecklistItems
                    .indexWhere((element) =>
                        element.checklistItemId ==
                        widget.checklistDetails.itemId);
                widget.certificationCubit.tempLoadTestChecklistItems
                    .elementAt(index)
