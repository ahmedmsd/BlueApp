              ...
              (index) => Column(
                ...
                children: [
                  StepIconAndDotLineWidget(
                    ...
                    iconColor: index > cubit.viewLoadTestCurrentStepIndex
                        ? Colors.black
                        : Colors.white,
                    circleColor: _circleColor(
                      circleIndex: index,
                      currentStepIndex: cubit.viewLoadTestCurrentStepIndex,
                    ),
                    currentStep: index <= cubit.viewLoadTestCurrentStepIndex
                        ? true
                        : false,
                  ),
                  ...
                  Text(
                    _stepTextList[index],
                    style: index == cubit.viewLoadTestCurrentStepIndex
