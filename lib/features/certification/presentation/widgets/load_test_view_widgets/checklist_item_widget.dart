...
import 'package:test_workapp/features/certification/presentation/widgets/load_test_view_widgets/comment_widget.dart';
import 'package:test_workapp/isar_service.dart';

class ChecklistItemWidget extends StatefulWidget {
  const ChecklistItemWidget({
    Key? key,
    required this.loadTestCheckListItem,
    required this.checklistDetailsIndex,
  }) : super(key: key);

  final LoadTestCheckListItem loadTestCheckListItem;
...
class _ChecklistItemWidgetState extends State<ChecklistItemWidget> {
  ...
  @override
  void initState() {
    groupvalue = widget.loadTestCheckListItem.passFail ?? '0';
    super.initState();
  }
              ...
              Column(
                ...
                children: [
                  SizedBox(
                    width: 0.7.sw,
                    child: Text(
                      widget.loadTestCheckListItem.itemTitle ?? '',
                  ...
                  SizedBox(
                    width: 0.7.sw,
                    child: Text(
                      widget.loadTestCheckListItem.reference ?? '',
                      maxLines: null,
                      style: TextStyle(
                        fontSize: 14.0.sp,
                      ),
                        ...
                        children: [
                          Padding(
                            ...
                            child: AppSvgIcon(
                              ...
                              iconColor:
                                  widget.loadTestCheckListItem.comment == null
                                      ? null
                                      : Colors.green,
                            ),
                          ),
